  ...
  return (
    <StyledWrapper>
      ...
      >
        ...
        <g>
          <g strokeWidth={4} strokeDasharray="12 12" strokeLinecap="round" transform="translate(80,80)">
            {[...Array(8)].map((_, i) => (
              <polyline
                key={i}
                className="pl__tick"
...
height: 180px;
  ...
  .pl__tick:nth-child(6){animation-delay:-.75s}
  .pl__tick:nth-child(7){animation-delay:-.5s}
  .pl__tick:nth-child(8){animation-delay:-.25s}
